...
7. 668 score164/176 または p=167 near-hit は catalog に載せられたか: `113` candidates.
8. 668 near-hit は p=37 trap type と似ていたか: `not_supported`.
9. trap type ごとに有効な operator の違いは見えたか: `supported`.
10. H-TRAP1, H-TRAP2, H-TRAP3, H-TRAP4 の判定はどうか: `{"H_TRAP1": "not_supported", "H_TRAP2": "supported", "H_TRAP3": "not_supported", "H_TRAP4": "supported"}`.
