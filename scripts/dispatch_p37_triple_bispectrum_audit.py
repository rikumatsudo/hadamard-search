...
WORKFLOW = "p37-triple-bispectrum-audit.yml"


PRESETS = {
    "remote-smoke": {
        "run_label": "p37-triple-bispectrum-smoke",
        "sample_sizes": "10",
        "metric_mode": "smoke",
        "max_candidates": "2",
        "max_tasks": "2",
    ...
    "p37-triple-bispectrum-40": {
        "run_label": "p37-triple-bispectrum-40x",
        "sample_sizes": "100,300,1000,full",
        "metric_mode": "full",
        "max_candidates": "0",
        "max_tasks": "0",
        "exact_derived_count": "24",
...
def parse_args():
    parser = argparse.ArgumentParser(description="Build or dispatch p37 triple bispectrum audit runs.")
