...
WORKFLOW = "p37-exact-like-feature-registry.yml"


PRESETS = {
    "remote-smoke": {
        "run_label": "p37-exact-like-feature-registry-smoke",
        "sample_sizes": "10",
        "metric_mode": "smoke",
        "max_candidates": "2",
        "max_tasks": "2",
    ...
    "p37-exact-like-feature-registry-40": {
        "run_label": "p37-exact-like-feature-registry-40x",
        "sample_sizes": "100,300,1000,full",
        "metric_mode": "full",
        "max_candidates": "0",
        "max_tasks": "0",
...
def parse_args():
    parser = argparse.ArgumentParser(description="Build or dispatch p37 exact-like feature registry runs.")
