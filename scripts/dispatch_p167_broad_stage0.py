...
WORKFLOW = "p167-broad-tuple-trajectory-calibration.yml"


PRESETS = {
    "remote-smoke": {
        "run_label": "p167-broad-stage0-smoke",
    ...
    "stage0-40": {
        "run_label": "p167-broad-stage0-40x",
        "config": "configs/experiments/p167_broad_tuple_stage0_calibration.yaml",
        "tuple_registry": "configs/fixtures/p167_tuple_classes.json",
        "benchmark_trap_manifest": "configs/fixtures/benchmark_traps/p167_score164_176.jsonl",
        "seed_families": "pure_random,mixed_diversity",
        "operators": "baseline_score_only,random_walk_score_guarded,focused_plus_small_threshold",
        "restarts": "1",
        "steps": "200",
        "sample_swaps": "100",
        "diagnostic_sample_count": "100",
        "snapshot_attempted_steps": "0,25,50,100,200",
        "snapshot_accepted_moves": "0,25,50,100",
        "mixed_diversity_pool": "4",
    ...
    "stage0-lite-40": {
        "run_label": "p167-broad-stage0-lite-40x",
        "config": "configs/experiments/p167_broad_tuple_stage0_calibration.yaml",
        "tuple_registry": "configs/fixtures/p167_tuple_classes.json",
        "benchmark_trap_manifest": "configs/fixtures/benchmark_traps/p167_score164_176.jsonl",
        "seed_families": "pure_random,mixed_diversity",
        ...
        "steps": "100",
        "sample_swaps": "50",
        "diagnostic_sample_count": "50",
        "snapshot_attempted_steps": "0,25,50,100",
        "snapshot_accepted_moves": "0,25,50",
        "mixed_diversity_pool": "4",
        "high_resolution_logging": "false",
        "highres_followup_accepted_moves": "50",
        "max_tasks": "0",
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Build or dispatch p167 broad tuple Stage 0 calibration runs."
    )
