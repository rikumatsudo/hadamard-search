...
.
  ...
  docs/production-runs.md              20/40 shard本番runの手順
  ...
  scripts/dispatch_research_run.py     GitHub Actions runのdry-run/dispatch helper
...
20/40 shard本番runの固定手順は [docs/production-runs.md](docs/production-runs.md) にあります。
...
- `scripts/dispatch_research_run.py`: remote smoke、20 shard、40 shard runのdispatch helper。
